...
function Wave() {
  ...
  //using a pre exiasting code to start but adapting it
  ...
  this.showBall = ellipse(150 * this.xspacing, height/2 + this.yvalues[150], 160, 160);
  ...
  this.renderWave = function() {
    ...
    if(this.showBall) {
      ellipse(150 * this.xspacing, height/2 + this.yvalues[150], 70, 70);  
    }
